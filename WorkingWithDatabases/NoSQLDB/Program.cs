...
namespace NoSQLFilmReviews
{
    internal class Program
    {
        ...
        {
            //var settings = MongoClientSettings.FromConnectionString("mongodb+srv://demo-user:5Z8yRIFkTsm4vcya@cluster0.hgliefa.mongodb.net/?retryWrites=true&w=majority");
            ...
            //var settings = MongoClientSettings.FromConnectionString("mongodb+srv://demo-user:5Z8yRIFkTsm4vcya@cluster0@cluster0.hgliefa.mongodb.net/?retryWrites=true&w=majority");
            //settings.ServerApi = new ServerApi(ServerApiVersion.V1);
            //var client = new MongoClient(settings);
            //var database = client.GetDatabase("test");

            var settings = MongoClientSettings.FromConnectionString("mongodb+srv://demo-user:5Z8yRIFkTsm4vcya@cluster0.s7jjkdj.mongodb.net/?retryWrites=true&w=majority");
            settings.ServerApi = new ServerApi(ServerApiVersion.V1);
            var client = new MongoClient(settings);
            var database = client.GetDatabase("test");
